...
def system_operators(Single_El_Int,Double_El_Int,Nel,N_qu_vib_modes,El_Nuclear_Couplings_cl,
    ...
    def molham_func(dim_rho,d_ops,El_Nuclear_Couplings_cl,x_vec):
        ...
        # molham_x += Ham_el
        # molham_x += El_Nuclear_Couplings_cl[0]*x_vec[0]*np.matmul(d_ops[:,:,0,0],d_ops[:,:,0,1])
    ...
    d_ops_dressed_log = np.array(d_ops_dressed,dtype=bool)
    Ham_log = np.array(Ham,dtype=bool)
    ...
    if N_qu_vib_modes == 0:
        return d_ops,d,ddag,Fock_states,molham_func,molham_log,d_ops_log,rho_0_log,identity_dim_rho,d_ops_dressed,\
               d_ops_dressed_log,Ham,Ham_log
    else:
        return d_ops,d,ddag,Fock_states,molham_func,molham_log,d_ops_log,rho_0_log,identity_dim_rho,d_ops_dressed,\
               d_ops_dressed_log,Ham,Ham_log,b_ops,b,bdag
